...
namespace WmiFramework.Demo.Services
{
    ...
    /// </summary>
    public class Win32_MemoryDevice : WMIService<Entites.Win32_MemoryDeviceEntity>
    {
        public Win32_MemoryDevice(ConnectionOptions options, string address) : base(options, address) { }
        /// <summary>
        ...
        /// <param name="Time"></param>
        /// <returns></returns>
        public uint SetPowerState(Entites.Win32_MemoryDeviceEntity entity, ushort PowerState, DateTime Time)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public uint Reset(Entites.Win32_MemoryDeviceEntity entity)
        {
            var classObj = GetEntityWmiObjecj(entity);
            var inParams = classObj.GetMethodParameters("Reset");
            var output = classObj.InvokeMethod("Reset", inParams, null);
