...
namespace WmiFramework.Demo.Services
{
    ...
    /// </summary>
    public class Win32_Processor : WMIService<Entites.Win32_ProcessorEntity>
    {
        public Win32_Processor(ConnectionOptions options, string address) : base(options, address) { }
        /// <summary>
        ...
        /// <param name="Time"></param>
        /// <returns></returns>
        public uint SetPowerState(Entites.Win32_ProcessorEntity entity, ushort PowerState, DateTime Time)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public uint Reset(Entites.Win32_ProcessorEntity entity)
        {
            var classObj = GetEntityWmiObjecj(entity);
            var inParams = classObj.GetMethodParameters("Reset");
            var output = classObj.InvokeMethod("Reset", inParams, null);
